...
use Digitalatrium\Gigya\Service\GSKeyNotFoundException;
use Digitalatrium\Gigya\Service\GSObject;
use Digitalatrium\Gigya\Service\GSArray;
use Digitalatrium\Gigya\Service\GSResponse;
use Digitalatrium\Gigya\Service\SigUtils;
...
class GSRequest
{
    ...
    {
        GSRequest::$cafile = storage_path('cert/cacert.pem');
    }
    /**
...
// GSRequest::__constructStatic(); // TODO: maybe move to constructor? (Zoran)
