...
use Digitalatrium\Gigya\Service\GSObject;
...
class GSResponse
{
    ...
    private static $errorMsgDic = null;
    private $params = null;
    private $method = null;
    private $traceLog = null;
    public static function getErrorMsgDic() //TODO: maybe move to constructor? (Zoran)
    {
        if (is_null(self::$errorMsgDic)) {
    ...
    public function getErrorMessage()
    {
        if (isset($this->errorMessage))
            ...
            if ($this->errorCode == 0 || !self::getErrorMsgDic()->containsKey((int)$this->errorCode))
                return "";
            else
                return self::getErrorMsgDic()->getString($this->errorCode);
        }
    }
...
// GSResponse::Init(); // TODO: maybe remove this in favour of constructor (Zoran)